# Changelog — archive (0.1.0 – 1.0.3)

> **Scope:** older release-note sections moved out of
> [`CHANGELOG.md`](CHANGELOG.md) to keep that file scannable
> ([`docs/dev/reviews/2026-07-efficiency/prescriptions.md`](docs/dev/reviews/2026-07-efficiency/prescriptions.md)
> PX-48). This content is **byte-preserved** — cut, not re-authored — from the
> live file. Current and recent releases ([Unreleased] through 1.0.4) stay in
> `CHANGELOG.md`; this file picks up where that one's history trails off.
