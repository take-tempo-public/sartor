...
## Step 3 — Compose
Here sartor proposes the résumé for this job: the title it chose for each role
...
`.docx` for sartor to reuse (ATS-safe strongly recommended). See
[[resume-templates]].

## Step 5 — Generate
Choose your output format and click **Generate**. sartor writes the final,
...
[`../overview.md`](../overview.md). Back to [[using-sartor]].
