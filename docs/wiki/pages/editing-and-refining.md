...
> the text in place, asking callback to refine it, and how your edits carry into the
> next version.
...
Once callback generates your résumé in **Step 6**, the result isn't fixed — you can
shape it two ways: edit the words yourself, or ask callback to refine it for you.
...
## Asking callback to refine
Type a short instruction in the refinement box — "tighten the summary", "lead with the
data role" — and callback rewrites the draft with that in mind, still grounded in your
...
draft. That's why small fixes stick: callback carries them forward instead of starting
