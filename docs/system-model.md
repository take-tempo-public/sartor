...
letter — to a specific job **without inventing anything about you**. You paste in a
job description; it reads the posting, asks a few sharp questions, helps you choose
which of your real accomplishments fit, then writes a tailored draft grounded
entirely in your actual history and renders it to Word or PDF. It runs on your own
machine; your career data never leaves it, apart from the calls to the AI model that
does the writing.
...
**fabricate** — no invented titles, numbers, or dates. That single constraint shapes
the entire design, and it recurs at every scale of the system below.
...
4. **The opening.** Lead with "without inventing anything about you" (as it does
