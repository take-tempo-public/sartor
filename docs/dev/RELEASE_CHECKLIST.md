...
- [ ] **UX round-2 remediation (e2e feedback 2026-07-09)** — the owner's second
      ...
      post-v1.0.8, version slot TBD vs the v1.0.9 docs epic). Dates (O1b) stay separately
      reopened — evidence-first research, owner-pending, not yet scoped to the epic or a
      branch. _(discovered: 2026-07-09, `fix/round2-quick-wins`; open count 5 → 6.)_
