...
_Open count: 8 — **at** the ~8–10 reduction-sprint threshold; the next stream should plan a reduction pass (the link-checker #4 + CONTRIBUTING drift #5 are the natural pair to clear)._
