...
- [x] **Assistant doc-coverage — author the how-to content the avatar draws on** — **DONE
      ...
      `overview.md` (D5). `index.md` lists all 7 (User-facing education); hub `using-callback`
