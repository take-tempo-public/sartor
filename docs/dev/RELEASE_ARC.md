...
| `fix/clarify-generates-bullets` | KW4 | Clarify asks questions but adds no new bullets to the corpus — confirm defect vs expected first, verify across two clarify rounds, then fix. |
