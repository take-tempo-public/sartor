...
the app.py -> blueprints decomposition). Owns the 50 routes that manage a
candidate's structured corpus — experiences, bullets, titles, summaries,
experience-summaries, skills, education, certifications, tags, duplicates,
resume upload + ingest, the pending-review accept workflow, and the
LLM-proposal lifecycle (critique / decide / promote-to-bullet).
...
Submodules (route count):
    ...
    skills.py         skills (4)
    career_assets.py  education + certifications (8) — F-04, UX-W1
