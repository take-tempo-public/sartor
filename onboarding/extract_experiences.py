...
- "end_date" (string or null) — "YYYY-MM" or null for current/ongoing
...
- If you cannot identify start_date for an experience, OMIT THE WHOLE EXPERIENCE rather than guessing. Dates anchor the audit trail.
...
def _normalize_experience(raw: dict) -> ExtractedExperience:
    ...
    # Drop experiences with malformed date stamps — the schema requires YYYY-MM.
