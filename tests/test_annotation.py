...
def _bootstrap_doc() -> dict:
    ...
    bullet_clusters = [
        {"representative": "Led migration of billing platform to Kubernetes",
         "members": ["..."], "jd_files": ["a.txt", "b.txt"], "size": 2},
        {"representative": "Built HIPAA-compliant claims pipeline",
         "members": ["..."], "jd_files": ["b.txt"], "size": 1},
        {"representative": "Cut p99 latency by improving caching",
         "members": ["..."], "jd_files": ["a.txt"], "size": 1},
        {"representative": "Mentored two engineers",
         "members": ["..."], "jd_files": ["a.txt"], "size": 1},
    ]
    skill_clusters = [
        {"representative": "Python", "members": ["Python"], "jd_files": ["a.txt", "b.txt"], "size": 2},
        {"representative": "Kubernetes", "members": ["Kubernetes"], "jd_files": ["a.txt"], "size": 1},
    ...
    grounding = {
        ...
        "nli": [
            {"bullet": "Led migration of billing platform to Kubernetes",
             "nli_entailment_score": 0.88, "nli_contradiction_flag": False},
            {"bullet": "Built HIPAA-compliant claims pipeline",
             "nli_entailment_score": 0.12, "nli_contradiction_flag": True},
            {"bullet": "Cut p99 latency by improving caching",
             "nli_entailment_score": 0.75, "nli_contradiction_flag": False},
            {"bullet": "Mentored two engineers",
             "nli_entailment_score": 0.66, "nli_contradiction_flag": False},
        ],
        "nli_summary": {"mean_entailment": 0.60, "contradiction_count": 1},
        "minicheck": [
            {"bullet": "Led migration of billing platform to Kubernetes", "minicheck_grounding_score": 0.95},
    ...
    return {
        ...
        "jd_count": 2,
        "per_jd": [
            {"jd_file": "a.txt", "run_id": "r1", "analysis": {},
             "clarification_questions": [{"id": "q1", "text": "Tell me about X", "kind": "experience_probe"}],
             "clarification_reasoning": "", "generated_resume": "", "generated_cover_letter": "",
             "bullets": [], "skills": []},
            {"jd_file": "b.txt", "run_id": "r2", "analysis": {},
             "clarification_questions": [{"id": "q2", "text": "What are your strengths?", "kind": "scope_probe"}],
             "clarification_reasoning": "", "generated_resume": "", "generated_cover_letter": "",
             "bullets": [], "skills": []},
        ],
        "dedup": {
...
def _annotations_doc() -> dict:
    ...
    return {
        ...
        "prompt_version": "2026-06-01.4",
        "bullets": [
            {"cluster_index": 0, "representative": "Led migration of billing platform to Kubernetes",
             "jd_files": ["a.txt", "b.txt"], "size": 2,
             "nli_entailment_score": 0.88, "nli_contradiction_flag": False,
             "minicheck_grounding_score": 0.95,
             "verdict": "keep", "failed_rules": [], "note": "", "should_omit": False,
             "honest_rewrite": None, "forbidden_pattern": None},
            {"cluster_index": 1, "representative": "Built HIPAA-compliant claims pipeline",
             "jd_files": ["b.txt"], "size": 1,
             "nli_entailment_score": 0.12, "nli_contradiction_flag": True,
             "minicheck_grounding_score": 0.80,
             "verdict": "fabricated", "failed_rules": ["jd_pandering"],
             "note": "Source has no healthcare work; re-skinned for the b.txt JD.",
             "should_omit": True, "honest_rewrite": None, "forbidden_pattern": "HIPAA"},
            {"cluster_index": 2, "representative": "Cut p99 latency by improving caching",
             "jd_files": ["a.txt"], "size": 1,
             "nli_entailment_score": 0.75, "nli_contradiction_flag": False,
             "minicheck_grounding_score": 0.70,
             "verdict": "fix", "failed_rules": ["scope_inflation"],
             "note": "Quantify honestly.", "should_omit": False,
             "honest_rewrite": "Reduced p99 latency by adding a read-through cache", "forbidden_pattern": None},
            {"cluster_index": 3, "representative": "Mentored two engineers",
             "jd_files": ["a.txt"], "size": 1,
             "nli_entailment_score": 0.66, "nli_contradiction_flag": False,
             "minicheck_grounding_score": 0.85,
             "verdict": "omit", "failed_rules": [], "note": "Redundant with the summary.",
             "should_omit": True, "honest_rewrite": None, "forbidden_pattern": None},
        ],
        "skills": [
            {"cluster_index": 0, "representative": "Python", "jd_files": ["a.txt", "b.txt"], "size": 2,
             "nli_entailment_score": None, "nli_contradiction_flag": None, "minicheck_grounding_score": None,
             "verdict": "keep", "failed_rules": [], "note": "", "should_omit": False,
             "honest_rewrite": None, "forbidden_pattern": None},
            {"cluster_index": 1, "representative": "Kubernetes", "jd_files": ["a.txt"], "size": 1,
             "nli_entailment_score": None, "nli_contradiction_flag": None, "minicheck_grounding_score": None,
             "verdict": "keep", "failed_rules": [], "note": "", "should_omit": False,
             "honest_rewrite": None, "forbidden_pattern": None},
            {"cluster_index": 2, "representative": "FHIR", "jd_files": ["b.txt"], "size": 1,
             "nli_entailment_score": None, "nli_contradiction_flag": None, "minicheck_grounding_score": None,
             "verdict": "fabricated", "failed_rules": ["jd_pandering"],
             "note": "No FHIR exposure in source.", "should_omit": True,
             "honest_rewrite": None, "forbidden_pattern": "FHIR"},
        ],
        "clarification_ratings": [
            {"jd_file": "a.txt", "question_id": "q1", "question_text": "Tell me about X",
             "kind": "experience_probe", "rating": 4, "failed_rules": [], "note": ""},
            {"jd_file": "b.txt", "question_id": "q2", "question_text": "What are your strengths?",
             "kind": "scope_probe", "rating": 2, "failed_rules": ["generic_question"],
...
class TestCollateExpected:
    ...
    def test_candidate_name_and_field_set(self) -> None:
        ...
        assert set(exp.keys()) == {
            "candidate_name", "must_keywords", "forbidden_inventions",
            "min_grounding_score", "min_keyword_coverage_score", "min_ats_format_score",
            "min_tone_score", "min_clarification_quality_score", "notes",
        }
